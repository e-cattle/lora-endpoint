...
static const u1_t PROGMEM DEVEUI[8] = { 0x00, 0x84, 0x5B, 0x67, 0x27, 0x25, 0x47, 0xB8 };
...
static const u1_t PROGMEM APPEUI[8] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x02, 0xBC, 0xB6 };

// Config device address
static const u4_t DEVADDR = 0x26031F0A /* TTN Device Address */ ; // <-- Change this address for every node!

// LoRaWAN NwkSKey, your network session key, 16 bytes
static const PROGMEM u1_t NWKSKEY[16] = { 0x58, 0x7C, 0xBF, 0x18, 0x26, 0xDF, 0x8E, 0xBB, 0x5B, 0xE6, 0x6E, 0x08, 0x4D, 0x50, 0xEC, 0xEC };

// LoRaWAN AppSKey, application session key, 16 bytes
static const u1_t PROGMEM APPSKEY[16] = { 0xCF, 0x91, 0xE2, 0x0A, 0x12, 0x5D, 0x6A, 0xF0, 0x31, 0xF4, 0x64, 0x7C, 0x16, 0x94, 0x62, 0x97 };

// This key should be in big endian format (or, since it is not really a
// number but a block of memory, endianness does not really apply). In
// practice, a key taken from ttnctl can be copied as-is.
// Choose MSB mode
static const u1_t PROGMEM APPKEY[16] = { 0x58, 0x7C, 0xBF, 0x18, 0x26, 0xDF, 0x8E, 0xBB, 0x5B, 0xE6, 0x6E, 0x08, 0x4D, 0x50, 0xEC, 0xEC };
